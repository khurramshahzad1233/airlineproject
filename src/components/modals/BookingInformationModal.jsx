...
const BookingInformationModal = ({ show, onClose, id, bookingConfirm }) => {
  ...
  return (
    <Modal centered size="lg" show={show} onHide={onClose}>
      <Modal.Header closeButton>
        <Modal.Title className="fs-3">Booking Confirmation</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        {bookingConfirm?.createOrder?.data?.passengers?.map((person) => (
          <ul className="row gy-3 row-cols-1 row-cols-sm-2 row-cols-lg-3">
            <li>
            ...
            <li>
              <h6 className="mb-2 text-uppercase text-black-50 ">ID</h6>
              <h5 className="pr-2">{id}</h5>
            </li>
            <li>
              <h6 className="mb-2 text-uppercase text-black-50">
                BOOKING DATE
              ...
              <h5>
                {formatDate(bookingConfirm?.createOrder?.data?.created_at)}
              </h5>
            </li>
          </ul>
        ))}
              ...
              <li>
                ...
                <h6 className="mb-1">
                  <b className="fs-5 me-1">
                    {timeFormatter(
                      item?.segments[0]?.departure_datetime,
                      "time"
                    )}
                  </b>
                  <span>
          ...
          <ul className="row gy-3 row-cols-2 row-cols-sm-3 row-cols-lg-5 mt-2">
            ...
            <li>
              ...
              <h4 className="mb-0  fw-semibold">
                {bookingConfirm?.createOrder?.data?.total_amount}{" "}
        ...
        <div className="mt-3">
          <div className="bg-warning bg-opacity-50 rounded-2 p-3">
          ...
          <ul className="list-disc small ps-4 mx-0 row row-cols-1 row-cols-lg-2 gy-2 mt-2">
            ...
            <li className="ps-0 pe-4">
              ...
              <span>
                Please be sure to check your flight departure time 24 hours
                before the flight.
              </span>
            </li>
            <li className="ps-0 pe-4">
            ...
            <li className="ps-0 pe-4">
              <b className="me-1">
                The quantity of baggage items is the quantity of bags that you
                can check in as baggage.
              </b>
              <span>
